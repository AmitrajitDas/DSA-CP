...
<pre style="position: relative;"><strong>Input:</strong> ops = ["5","2","C","D","+"]
...
<pre style="position: relative;"><strong>Input:</strong> ops = ["5","-2","4","C","D","9","+","+"]
...
<pre style="position: relative;"><strong>Input:</strong> ops = ["1"]
