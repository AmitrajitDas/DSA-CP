...
<pre style="position: relative;"><strong>Input:</strong> text1 = "abcde", text2 = "ace" 
...
<pre style="position: relative;"><strong>Input:</strong> text1 = "abc", text2 = "abc"
<strong>Output:</strong> 3
...
<pre style="position: relative;"><strong>Input:</strong> text1 = "abc", text2 = "def"
